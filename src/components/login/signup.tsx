    ...
    <>
      <MDBValidation>
        <div className="d-flex flex-column mb-3">
          <MDBValidationItem className='mb-3' feedback='Please provide a valid first name.' tag="span" invalid>
            <div className="inputWithIcon">
              <MDBInput onChange={(e) => handleChnage(e)} value={formState.email} label='First Name' name='firstName' id='typeText' type='text' required pattern={emailPattern} />
              <i className="fa fa-user fa-lg fa-fw left-icon" aria-hidden="true"></i>
            </div>
          </MDBValidationItem>
          <MDBValidationItem className='mb-3' feedback='Optional' tag="span" invalid>
            <div className="inputWithIcon">
              <MDBInput onChange={(e) => handleChnage(e)} value={formState.email} label='Last Name' name='lastName' id='typeText' type='text' required pattern={emailPattern} />
              <i className="fa fa-user fa-lg fa-fw left-icon" aria-hidden="true"></i>
            </div>
          </MDBValidationItem>
